...
import zekkoNetworks from './networks';
import { NetworkNames } from '@enkryptcom/types';

export default class ZekkoProvider
  ...
  implements BackgroundProviderInterface
{
  ...
  constructor(
    toWindow: (message: string) => void,
    network: BaseNetwork = zekkoNetworks[NetworkNames.Zekko],
  ) {
    super();
    ...
    this.namespace = ProviderName.zekko;
